...
class JdbcWarehouseTestAction(ExecutionAction):
    ...
    def execute(self, context, **params) -> Dict[str, Any]:
        ...
        if not os.path.exists(skill_dir):
            skill_dir = '/Users/wendy/PycharmProjects/cc_free_coder/skills/jdbc-warehouse-test'
        ...
        if os.path.exists(skill_dir):
            ...
            if os.path.exists(script_path):
                try:
                    ...
                    temp_dir = '/tmp/jdbc_warehouse_test'
                    ...
                    modified_content = original_content.replace(
                        '/Users/wendy/PycharmProjects/cc_free_coder/JBDC入仓/BIZ_REQ_33706_001_批量入仓_新增任务/test_data',
                        temp_dir
                    )

                    temp_script = os.path.join(temp_dir, 'template_updater.py')
                    ...
                    if os.path.exists(template_file):
                        shutil.copy(template_file, temp_dir)

                    args = ['/usr/local/bin/python3', temp_script,
                    ...
                    generated_file = os.path.join(temp_dir, 'batch_test_latest.xlsx')
                    
                    project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
                    skill_dir = os.path.join(project_root, 'skills', 'jdbc-warehouse-test')
