...
class ActionRegistry:
    ...
    def discover(self):
        ...
        try:
            import actions.generic.skill_bridge
        except ImportError as e:
            print(f"Warning: 无法导入动作模块 actions.generic.skill_bridge: {e}")
        ...
        try:
            import actions.business.dataops.api
        except ImportError as e:
            print(f"Warning: 无法导入动作模块 actions.business.dataops.api: {e}")

        try:
            import actions.business.dataops.db_assertion
        except ImportError as e:
            print(f"Warning: 无法导入动作模块 actions.business.dataops.db_assertion: {e}")
